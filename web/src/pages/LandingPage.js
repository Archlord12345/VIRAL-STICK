    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #0a0a1a 0%, #1a1a2e 100%)' }}>
      ...
      <header style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          />
          <h1 style={{ margin: 0, fontSize: '28px', fontWeight: '800', background: 'linear-gradient(135deg, #7c3aed, #3b82f6)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
            Viral Stick
          </h1>
        </div>
        ...
        <div style={{ 
          ...
          <div>
            ...
            <p style={{ 
              ...
              Transformez vos textes, voix et images en stickers viraux grâce à nos 7 compagnons IA. 
              Context Reader, Voice-to-Meme, Status Remixer — tout est possible.
            </p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <CompanionAvatarWeb companion="arch" size={280} />
          </div>
        </div>
      </section>
            ...
            {[
              ...
              >
                <div style={{ position: 'relative', zIndex: 1 }}>
                  ...
                  <h3 style={{ fontSize: '24px', fontWeight: '800', marginBottom: '8px' }}>{feature.title}</h3>
                  <p style={{ 
                    fontSize: '14px', 
                    color: feature.color, 
                    fontWeight: '600',
                  ...
                  <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <CompanionAvatarWeb companion={feature.companion} size={64} />
                  </div>
                </div>
              </div>
            ))}
      ...
      <section style={{ padding: '100px 40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '24px' }}>
            {['arch', 'para', 'secu', 'data', 'bio', 'ubu', 'art'].map((companion) => (
              <div
                key={companion}
                style={{
                  background: 'rgba(255, 255, 255, 0.03)',
              ...
              >
                <CompanionAvatarWeb companion={companion} size={80} />
                <h3 style={{ 
                  fontSize: '18px', 
                  fontWeight: '700', 
                  marginTop: '16px', 
      ...
      <section style={{ padding: '100px 40px' }}>
        <div style={{
          ...
          <p style={{ fontSize: '18px', color: 'rgba(255, 255, 255, 0.6)', marginBottom: '32px' }}>
            Rejoignez des milliers de créateurs et générez vos premiers mèmes IA maintenant
          </p>
          <Link
            to="/context"
            style={{
      ...
      <footer style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            />
            <h3 style={{ margin: 0, fontSize: '18px', fontWeight: '700' }}>Viral Stick</h3>
          </div>
