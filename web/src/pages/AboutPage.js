  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #0a0a1a 0%, #1a1a2e 100%)' }}>
      ...
      <header style={{ 
        ...
        <h1 style={{ margin: 0, fontSize: '20px', fontWeight: '800' }}>À propos</h1>
      </header>
      ...
      <main style={{ 
        ...
        <div style={{ 
          ...
          <p style={{ 
            ...
            Un générateur de mèmes et stickers multimodal propulsé par l'intelligence artificielle. 
            Transformez vos textes, voix et images en contenu viral avec nos 7 compagnons IA uniques.
          </p>
          
          <a 
            href="https://github.com/kernel-forge/viral-stick"
            target="_blank"
          ...
          <div style={{ 
            ...
            {[
              ...
              >
                ...
                <span style={{ fontSize: '15px', fontWeight: '500' }}>{tech.name}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            {TEAM.map((member, index) => (
              ...
              >
                <CompanionAvatarWeb companion={member.companion} size={80} />
                <h4 style={{ 
                  fontSize: '18px', 
                  fontWeight: '700', 
                  marginTop: '20px',
