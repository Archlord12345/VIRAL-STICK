...
const SettingsPage = () => {
  ...
  const handleSave = async () => {
    ...
    setStatusType('info');
    try {
      const response = await fetch('http://localhost:3000/api/debug/update-keys', {
        method: 'POST',
    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #0a0a1a 0%, #1a1a2e 100%)' }}>
      ...
      <header style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <CompanionAvatarWeb companion="para" size={48} />
          <h1 style={{ margin: 0, fontSize: '20px', fontWeight: '800' }}>Paramètres</h1>
        </div>
      </header>
      ...
      <main style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '24px' }}>
            <CompanionAvatarWeb companion="para" size={64} />
            <div>
              <h2 style={{ margin: 0, fontSize: '24px', fontWeight: '800', marginBottom: '4px' }}>Para</h2>
              <p style={{ margin: 0, fontSize: '14px', color: 'rgba(255, 255, 255, 0.6)' }}>Gestionnaire des paramètres</p>
            </div>
          </div>
          ...
          <p style={{ 
            ...
            Configurez vos clés API pour les services IA. Ces clés sont stockées uniquement en session 
            et ne sont pas persistantes.
          </p>
          ...
          <div style={{ 
            ...
            <p style={{ 
              ...
              <span><strong>Important :</strong> Ne partagez jamais vos clés API. 
              Elles sont utilisées uniquement pour cette session locale.</span>
            </p>
          </div>
        </div>
      </main>
