...
const PAGES = [
  { key: "welcome", icon: "home",    companion: "art",  title: "Bienvenue sur Viral Stick", subtitle: "Studio IA de mèmes", desc: "Transformez textes, voix et images en mèmes viraux avec vos 7 compagnons IA." },
  { key: "context", icon: "book",    companion: "art",  title: "Context Reader",             subtitle: "Texte → Mème",       desc: "Collez un extrait de discussion — l'IA génère le mème adapté à votre culture." },
  { key: "voice",   icon: "mic",     companion: "ubu",  title: "Voice to Meme",              subtitle: "Voix → Mème",        desc: "Parlez et l'IA transforme vos mots en mèmes hilarants en temps réel." },
  { key: "remix",   icon: "image",   companion: "bio",  title: "Status Remixer",             subtitle: "Image → Mème",       desc: "Importez une image et laissez Bio créer un remix visuel unique." },
  { key: "chat",    icon: "message-circle", companion: "data", title: "Companion Chat",      subtitle: "Discutez avec l'IA", desc: "Échangez avec 7 compagnons spécialisés pour des conversations créatives." },
  { key: "ready",   icon: "zap",     companion: "arch", title: "Prêt à commencer ?",         subtitle: "L'aventure commence", desc: "Explorez toutes les fonctionnalités et créez du contenu viral dès maintenant !" },
];
  ...
  return (
    <View style={[styles.root, { backgroundColor: theme.background }]}>
      ...
      <View style={styles.bottom}>
        ...
        <TouchableOpacity
          onPress={goNext}
          style={[styles.nextBtn, { backgroundColor: theme.primary, shadowColor: theme.primaryLight }]}
          activeOpacity={0.85}
        >
...
const styles = StyleSheet.create({
  root:        { flex: 1 },
  skip:        { position: "absolute", top: 60, right: 20, zIndex: 10, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, borderWidth: 1 },
  ...
  circle:      { width: width * 0.72, height: width * 0.72, borderRadius: width * 0.36, borderWidth: 2, alignItems: "center", justifyContent: "center" },
  companionImg:{ width: width * 0.52, height: width * 0.52 },
  iconBadge:   { position: "absolute", bottom: 8, right: 8, width: 48, height: 48, borderRadius: 24, borderWidth: 1, alignItems: "center", justifyContent: "center", shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 2 },
  ...
  nextBtn:     { paddingHorizontal: 46, paddingVertical: 15, borderRadius: 30, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.25, shadowRadius: 8, elevation: 4 },
